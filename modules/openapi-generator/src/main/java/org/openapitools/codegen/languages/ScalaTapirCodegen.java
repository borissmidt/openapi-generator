...
public class ScalaTapirCodegen extends AbstractScalaCodegen implements CodegenConfig {
    private static final StringProperty TAPIR_VERSION = new StringProperty("tapirVersion", "The version of tapir", "0.19.3");
    ...
    private static final StringProperty CIRCE_VERSION = new StringProperty("circeVersion", "The version of circe " +
            "library", "0.13.0");
    private static final StringProperty UPICKLE_VERSION = new StringProperty("upickleVersion", "The version of upickle " +
            "library", "1.4.4");
    private static final StringProperty JSONITER_VERSION = new StringProperty("jsoniterVersion", "The version of jsoniter " +
            "library", "2.12.0");
    ...
    private static final List<Property<?>> properties = Arrays.asList(
            TAPIR_VERSION, USE_SEPARATE_ERROR_CHANNEL, JODA_TIME_VERSION,
            JSON4S_VERSION, CIRCE_VERSION,UPICKLE_VERSION,JSONITER_VERSION,
            JSON_LIBRARY_PROPERTY, PACKAGE_PROPERTY);
    ...
    public String getHelp() {
        return "Generates a Scala client library (beta) based on Tapir.";
    }

    @Override
    public ExtendedCodegenOperation fromOperation(String path,
                                          String httpMethod,
                                          Operation operation,
                                          List<Server> servers) {
        CodegenOperation op = super.fromOperation(path, httpMethod, operation, servers);
        op.path = encodePath(path);
        return new ExtendedCodegenOperation(op);
    }
    class ExtendedCodegenOperation extends CodegenOperation {
        ...
        public ExtendedCodegenOperation(CodegenOperation o) {
            super();
            this.hasErrorResponses = o.responses.stream().anyMatch(x -> !x.is2xx);
            this.hasSuccessResponse = o.responses.stream().anyMatch(x -> x.is2xx);
